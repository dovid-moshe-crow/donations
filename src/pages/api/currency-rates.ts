...
type CurrencyCode = (typeof currencyCode)[number];

// class CurrencyConverter {
//   private currencyFrom: CurrencyCode;
//   private currencyTo: CurrencyCode;
...
//   private ratesCache: Record<string, { expiryDate: Date; rate: number }>;
//   constructor(params) {
//     this.currencyFrom = "";
//     this.currencyTo = "";
...
//           fetch(
//             `https://www.google.com/search?q=${this.currencyFrom}+to+${this.currencyTo}+&hl=en`,
...
//     return this.rates().then((rates: any) => {
